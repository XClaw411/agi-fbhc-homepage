...
const groups = [
  {
    ...
    description: '聚焦大模型、智能体系统、工具调用、科研智能体与复杂任务规划。',
  ...
  },
  {
    ...
    description: '面向生命科学问题，探索 AI 在生物数据建模、分子表征、生命系统理解中的应用。',
    keywords: ['Bioinformatics', 'Foundation Models', 'Molecular AI'],
    icon: Dna,
    color: '#2dd4bf',
  ...
  },
  {
    ...
    description: '聚焦医学人工智能、健康数据分析、临床辅助决策与精准健康管理。',
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="display-lg text-[#F0F0F5]">Research Groups</h2>
          <p
