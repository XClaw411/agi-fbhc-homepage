    ...
    <section id="platforms" className="relative py-16 lg:py-24" style={{ background: '#0A0A12' }}>
      <div className="mx-auto max-w-[900px] px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="display-lg text-[#F0F0F5]">Platforms</h2>
        ...
        >
          ...
          <motion.div variants={cardVariants}>
            ...
            >
              ...
              <p className="mt-1 text-sm italic text-[#55556B]">
                AI-assisted scientific research workspace
              </p>
          ...
          <motion.div variants={cardVariants}>
            ...
            >
              ...
              <h3 className="mt-5 display-md text-[#F0F0F5]">
                XClaw Intelligent Email Subscription
              </h3>
              <p className="mt-1 text-sm italic text-[#55556B]">
                Personalized academic information delivery
              </p>
